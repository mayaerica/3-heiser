...
func TestSetMotorDirection(t *testing.T) {
	...
	for _, test := range tests {
		...
		if result != test.expected {
			t.Errorf("SetMotorDirection(%v) = %v; expected to be %v", test.input, result, test.expected)
		}
	}
}
...
func TestSetButtonLamp(t *testing.T) {
	...
	for _, test := range tests {
		...
		if result != test.expected {
			t.Errorf("SetButtonLamp(%v, %d, %v) = %v; expected to be  %v", test.button, test.floor, test.value, result, test.expected)
		}
	}
}
...
func TestSetFloorIndicator(t *testing.T) {
	...
	for _, test := range tests {
		...
		if result != test.expected {
			t.Errorf("SetFloorIndicator(%d) = %v; expected to be  %v", test.input, result, test.expected)
		}
	}
}
...
func TestSetDoorOpenLamp(t *testing.T) {
	...
	for _, test := range tests {
		...
		if result != test.expected {
			t.Errorf("SetDoorOpenLamp(%v) = %v; expected to be  %v", test.input, result, test.expected)
		}
	}
}
...
func TestSetStopLamp(t *testing.T) {
	...
	for _, test := range tests {
		...
		if result != test.expected {
			t.Errorf("SetStopLamp(%v) = %v; expected to be  %v", test.input, result, test.expected)
		}
	}
}
...
func TestToByte(t *testing.T) {
	...
	for _, test := range tests {
		...
		if result != test.expected {
			t.Errorf("ToByte(%v) = %v; expected to be  %v", test.input, result, test.expected)
		}
	}
}
...
func TestToBool(t *testing.T) {
	...
	for _, test := range tests {
		...
		if result != test.expected {
			t.Errorf("ToBool(%v) = %v; expected to be  %v", test.input, result, test.expected)
		}
	}
}
